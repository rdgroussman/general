...
def parse_all_dat_row(CountsDict, row):
	...
	if pfam_id not in CountsDict[phylo_group].keys():
		...
		# {1:[],2:[]}
		# old: CountsDict[phylo_group][pfam_id] = {'clock_time':{2:[], 6:[], 10:[], 14:[], 18:[], 22:[]},'abs_time':{0:[], 4:[], 8:[], 12:[], 16:[], 20:[], 24:[], 28:[], 32:[], 36:[], 40:[], 44:[], 48:[], 52:[], 56:[], 60:[], 64:[], 68:[], 72:[], 76:[], 80:[], 84:[], 88:[], 92:[], 92:[], }}
	...
	for sample_name in samples:
		...
		CountsDict[phylo_group][pfam_id]['clock_time'][clock_time][rep].append(FpKMx)
		CountsDict[phylo_group][pfam_id]['abs_time'][abs_time][rep].append(FpKMx)
...
def compute_stats(CountsDict):
	...
	for phylo_group in CountsDict.keys():
		...
		# pfam_id_list = CountsDict[phylo_group].keys()
		# pfam_id_list = pfam_id_list.remove('hi_group')
		# print pfam_id_list
