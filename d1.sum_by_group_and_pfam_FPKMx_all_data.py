...
def parse_all_dat_row(CountsDict, row):
	...
	if pfam_id not in CountsDict[phylo_group].keys():
		CountsDict[phylo_group][pfam_id] = {'clock_time':{2:[], 6:[], 10:[], 14:[], 18:[], 22:[]},'abs_time':{0:[], 4:[], 8:[], 12:[], 16:[], 20:[], 24:[], 28:[], 32:[], 36:[], 40:[], 44:[], 48:[], 52:[], 56:[], 60:[], 64:[], 68:[], 72:[], 76:[], 80:[], 84:[], 88:[], 92:[], 92:[], }}
	...
	for sample_name in samples:
		...
		CountsDict[phylo_group][pfam_id]['clock_time'][clock_time].append(FpKMx)
		CountsDict[phylo_group][pfam_id]['abs_time'][abs_time].append(FpKMx)
	...
	for phylo_group in CountsDict.keys():
		...
		for pfam_id in CountsDict[phylo_group]:
			...
			for clock_time in CountsDict[phylo_group][pfam_id]['clock_time']:
				#print clock_time
				StatsDict[phylo_group][pfam_id]['clock_time'][clock_time]['sum'] = sum(CountsDict[phylo_group][pfam_id]['clock_time'][clock_time])
				StatsDict[phylo_group][pfam_id]['clock_time'][clock_time]['max'] = max(CountsDict[phylo_group][pfam_id]['clock_time'][clock_time])
				StatsDict[phylo_group][pfam_id]['clock_time'][clock_time]['min'] = min(CountsDict[phylo_group][pfam_id]['clock_time'][clock_time])
				StatsDict[phylo_group][pfam_id]['clock_time'][clock_time]['mean'] = np.mean(CountsDict[phylo_group][pfam_id]['clock_time'][clock_time])
				StatsDict[phylo_group][pfam_id]['clock_time'][clock_time]['stdev'] = np.std(CountsDict[phylo_group][pfam_id]['clock_time'][clock_time])
				StatsDict[phylo_group][pfam_id]['clock_time'][clock_time]['n_contigs'] = len(CountsDict[phylo_group][pfam_id]['clock_time'][clock_time])

			for abs_time in CountsDict[phylo_group][pfam_id]['abs_time']:
				StatsDict[phylo_group][pfam_id]['abs_time'][abs_time]['max'] = max(CountsDict[phylo_group][pfam_id]['abs_time'][abs_time])
				StatsDict[phylo_group][pfam_id]['abs_time'][abs_time]['min'] = min(CountsDict[phylo_group][pfam_id]['abs_time'][abs_time])
				StatsDict[phylo_group][pfam_id]['abs_time'][abs_time]['mean'] = np.mean(CountsDict[phylo_group][pfam_id]['abs_time'][abs_time])
				StatsDict[phylo_group][pfam_id]['abs_time'][abs_time]['sum'] = sum(CountsDict[phylo_group][pfam_id]['abs_time'][abs_time])
				StatsDict[phylo_group][pfam_id]['abs_time'][abs_time]['stdev'] = np.std(CountsDict[phylo_group][pfam_id]['abs_time'][abs_time])
				StatsDict[phylo_group][pfam_id]['abs_time'][abs_time]['n_contigs'] = len(CountsDict[phylo_group][pfam_id]['abs_time'][abs_time])
...
def output_csv(ContigData, out_file_name):
	...
	header = ['phylo_group', 'pfam_id', 'time', 'mean', 'stdev','sum','n_contigs']
	...
	for phylo_group in CountsDict.keys():
		for pfam_id in CountsDict[phylo_group]:
			for clock_time in CountsDict[phylo_group][pfam_id]['clock_time']:
				out_fields = [phylo_group, pfam_id, str(clock_time)]
	...
	header = ['phylo_group', 'pfam_id', 'time', 'mean', 'max', 'min', 'stdev','sum','n_contigs']
	...
	for phylo_group in CountsDict.keys():
		for pfam_id in CountsDict[phylo_group]:
			for abs_time in CountsDict[phylo_group][pfam_id]['abs_time']:
				out_fields = [phylo_group, pfam_id, str(abs_time)]
