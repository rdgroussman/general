...
# modified from d1.count_kofam_by_taxid_rawcounts.py
# to sum up the standardized counts WITHOUT normalizing to length

"""
This script will take in a file like d1.combined_kofam_dmnd_std_norm_counts.csv:
...
for row in input_csv:
	...
	if phylo_group != "NA":
		...
		# here, we just add the standard-normalized counts
		for sample in sample_ids:
			CountsDict[tax_id][knum][sample] += float(row[sample])
