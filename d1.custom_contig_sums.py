...
73028	Prymnesiales
418919	Phaeocystales
73020	Isochrysidales
"""


cumulative_groups = ["2864", "33630", "2830", "33634", "2836", "39119", "33154", "35675", "3041", "33208", "543769", "2", "5878", "10239", "2157","73028","418919","73020"]
...
Stramenopiles - Bacillariophyta, Dictyochophyceae, Pelagophyceae
Opisthokonta - Metazoa
Haptophyceae - Prymnesiales, Phaeocystales, Isochrysidales
"""
# we'll subtract the counts in the values from the counts in the key (correspond to groups above)
adjusted_groups = { "33630":["2864","5878"], "33634":["2836","39119","35675"], "33154":["33208"], "2830":["73028","418919","73020"] }
...
for tax_id in cumulative_groups:
	CountsDict[tax_id] = {"total_counts":0}
# and we need a bin to catch 'Other' and 'None'
CountsDict["0"] = {"total_counts":0, "rank":"NA", "tax_name":"Other"}
CountsDict["None"] = {"total_counts":13934267, "rank":"None", "tax_name":"None"}
...
for row in counts_data:
	...
	# first, lets check to see if its in either of our groups:
	if tax_id in discrete_groups:
		CountsDict[tax_id]["total_counts"] += count # we can count this one right away
		IN_GROUP = True
...
# penultimately, we'll adjust the counts for some of the nested groups we want to keep separate:
